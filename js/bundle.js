    ...
    function getDynamicInformation(selector) {
        ...
        input.addEventListener('input', () => {
            ...
            if (input.value.match(/\D/g)) {
                input.style.boxShadow = '0px 0px 13px 0px rgba(168, 18, 50, 0.94)';
            } else {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function sliders({container, slide, nextArrow, prevArrow, totalCount, currentCounter, wrapper, field}) {
    //Slider
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-02-17');
